...
public class PdfView {
    ...
    public static void createWebPrintJob(Activity activity, WebView webView, File directory, String fileName, final Callback callback) {
        ...
        PrintDocumentAdapter printDocumentAdapter = (PrintDocumentAdapter) webView.createPrintDocumentAdapter(jobName);
        pdfPrint.print(printDocumentAdapter, directory, fileName, new PdfPrint.CallbackPrint() {
            @Override
