...
class LineIndicator @JvmOverloads constructor(
    ...
    init {
        ...
        mIndicatorColor =
            typedArray.getColor(R.styleable.LineIndicator_LineIndicator_Color, Color.GRAY)
        mIndicatorSelectedColor =
            typedArray.getColor(R.styleable.LineIndicator_LineIndicator_SelectedColor, Color.WHITE)
        mIndicatorWidth =
            typedArray.getDimension(R.styleable.LineIndicator_LineIndicator_Width, dp2px(5f))
        mIndicatorHeight =
            typedArray.getDimension(R.styleable.LineIndicator_LineIndicator_Height, dp2px(5f))
        typedArray.recycle()
